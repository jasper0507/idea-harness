...
## Blocking Unknowns
- [NEEDS CLARIFICATION] Confirm how the user will judge the result.

## Assumption Firewall
AI 不得假设：
- Login, history storage, file upload, database, export, or deployment.
...
Acceptance criteria: The user can paste text and get a useful result.
